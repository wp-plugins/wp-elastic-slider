...
Free WordPress Slider. Easy to use WordPress slider plugin. Create SEO optimised responsive slideshows with Elastic slideshow.
...
== Screenshots ==
1. Create slider from dashboard
2. Slider light color
3. Slider dark color
